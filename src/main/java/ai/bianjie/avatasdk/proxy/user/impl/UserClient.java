...
public class UserClient implements UserProxy {
    ...
    private static final String CREATE_USER = "/v2/users";// 创建用户

    private static final String UPDATE_USER = "/v2/users";// 更新用户

    private static final String QUERY_USER = "/v2/users";// 查询用户信息
